...
public class registro extends JFrame implements ActionListener {
    ...
    private JButton button1, button2, boton2;
...
public void actionPerformed(ActionEvent e) {
    // Verificar si el evento proviene del botón button1 (registro)
    ...
    // Verificar si el evento proviene del botón button2 (otra acción)
    else if (e.getSource() == boton2) {
        // Código para manejar el evento de button2
