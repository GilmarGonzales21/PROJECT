            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (text) {
                    case "NOSOTROS":
                        ...
                        hogarInfo hogarInfoScreen = new hogarInfo();
                        hogarInfoScreen.setVisible(true);
                        hogarInfoScreen.setBounds(0 , 0, 362, 640);
                        hogarInfoScreen.setLocationRelativeTo(null);
                        dispose();
                        break;
                    case "LOGIN":
                        // Acción para LOGIN
                    ...
                    case "REGISTER":
                        ...
                        registroScreem.setLocationRelativeTo(null);
                        dispose(); // Cierra la ventana del menú
                        break;
                    case "ORGANIZACION":
                        // Acción para ORGANIZACION
                        GrupoOrg GrupoOrgScreen = new GrupoOrg();
                        GrupoOrgScreen.setVisible(true);
                        GrupoOrgScreen.setBounds(0 , 0, 362, 640);
                        GrupoOrgScreen.setLocationRelativeTo(null);
                        dispose(); // Cierra la ventana del menú
                        break;
                    case "CONTACTOS":
                        ContactosApp contactosScreem = new ContactosApp();
                        contactosScreem.setVisible(true);
                        contactosScreem.setBounds(0, 0, 362, 640);
                        contactosScreem.setLocationRelativeTo(null);
                        dispose(); // Cierra la ventana del menú
                        break;
                }
            }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("≡")) {
            ...
            if (!menuVisible) {
                ...
                String[] menuItems = {"NOSOTROS", "LOGIN", "REGISTER", "ORGANIZACION", "CONTACTOS"};
