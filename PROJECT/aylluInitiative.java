...
public class aylluInitiative extends JFrame implements ActionListener{
    ...
    public aylluInitiative() {
        setLayout(null);
        setTitle("Kusimayo");

        // Configuración del título
        labelTitulo = new JLabel("Ayllu Initiative");
        labelTitulo.setBounds(70, 20, 300, 60);
        labelTitulo.setFont(new Font("Playground", Font.BOLD, 30));
        ...
        String textoCompleto =
                "Ayllu Initiative es una organización que se enfoca en el desarrollo " +
                "sostenible de comunidades rurales en Perú. Trabajan en proyectos de " +
                "agricultura sostenible, acceso al agua potable, educación y salud, promoviendo " +
                "el empoderamiento comunitario y la autogestión de los recursos locales para mejorar la calidad " +
        ...
        ImageIcon icon = new ImageIcon("ayllu.jpg"); // Cambia esto a la ruta de tu imagen
    ...
    public static void main(String args[]) {
        aylluInitiative principal = new aylluInitiative();
        principal.setBounds(0, 0, 362, 640);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == boton1) {
            ...
            dispose(); // Cierra la ventana del menú actual (aylluInitiative)
